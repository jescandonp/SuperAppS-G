...
public sealed record ScheduleExportRow(long AssignmentId,long PositionId,long? EmployeeId,string? EmployeeName,string Date,string StartsAt,string EndsAt,string Status);
