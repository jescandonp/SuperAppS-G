...
type Tab = "Proyectos" | "Plantillas" | "Matriz" | "Reglas" | "Comparar" | "Excepciones";
...
export function SchedulingPage({ user }: Props) {
  ...
  // El panel de proyectos escribe contra el backend por su cuenta; esto solo mantiene el
