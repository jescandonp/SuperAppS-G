...
## 1. Evidencia De La Ruta

Fuente aportada por el usuario: organigrama S&G codigo `GH-DE-01`, fecha
`24/07/2025`, version 4. El organigrama identifica los roles Director de
...
Cada rol debe diligenciar nombre, cargo, decision, observaciones, fecha y
evidencia/firma. Un campo sin diligenciar conserva la fila en `Pendiente`.
