...
|---|---|---|---|---|
| I9-R01 | Limites ordinarios y sectoriales con condicion juridica | Concepto sobre tratamiento posterior a 10 h/dia y evidencia del acuerdo escrito | Juridica y Operaciones | PENDIENTE_DE_PARAMETROS |
...
| Tratamiento despues de 10 h/dia | PENDIENTE | Concepto juridico expreso |
